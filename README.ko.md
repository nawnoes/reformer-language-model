...
[lucidrains/reformer-pytorch](https://github.com/lucidrains/reformer-pytorch)를 이용한 3가지 Reformer Language Model
...
## Vocab & Tokenizer
기존에 사용해보지 않은 Wordpiece Tokenizer 사용.
...
reformer-bert-small 모델에 대한 Korquad v1.0 결과  
...
![](./images/alm.png)
### Model
GPT-2 Small 모델 크기. **입력 토큰 수 5120와 1024** 2가지로 학습.
